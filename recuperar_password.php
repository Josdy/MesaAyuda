...
session_start();
	...
	<input type="text" name="user" placeholder="Nombre de usuario" required class="form-control input-lg"  /><br>
...
<span id="pastate" style="color: red" class="fas fa-times-circle"></span>  Coinciden las contraseñas
	...
	<button style="margin-top: 20px;" type="submit" name="recuperarpass" class="btn btn-block repabtn">Aceptar</button>
