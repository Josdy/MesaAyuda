...
,t2.nombre as nombresoporte, t2.paterno as soportep , t2.materno as soportem, p.tiempo_servicio as tiemposervicio
from problema p
...
<div class="col-6">
		...
		<input readonly type="number" value="<?php echo $tiemposervicio;?>" class="form-control col-4" />
